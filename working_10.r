...
for( i in 1:100) {
  ...
  write.table(calulateError(del_N=0.5, del_sigma=0.01, order=10, Q_POLY=10), sprintf("matrix%d.csv", i), col.names=FALSE,row.names=FALSE, sep=",")
}
